...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test_reparse(self):
        ...
        for x in range(15000, 15100):
            ...
            # Compare the new results against the old results
            bmrb.parse_mode = "sans"
            san_ent = bmrb.entry.fromFile(location)
            self.assertEqual(ent, san_ent)
            bmrb.parse_mode = "fast"
